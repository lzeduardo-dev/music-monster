            ...
            <PrivateRoute>
              <Layout>
                <Routes>
                  ...
                  <Route
                    path="/figuras-ritmicas"
                    element={<FigurasRitmicas />}
                  />
                  <Route path="/harmonia" element={<Harmony />} />
                  <Route
                    path="/harmonia-funcional"
                    element={<HarmoniaFuncional />}
                  />
                  ...
                  <Route
                    path="/escalas-avancadas"
                    element={<EscalasAvancadas />}
                  />
                  ...
                  <Route
                    path="/laboratorio-groove"
                    element={<LaboratorioGroove />}
                  />
                  <Route
                    path="/padroes-pentatonica"
                    element={<PadroesPentatonica />}
                  />
                ...
                ── */}
                  ...
                  <Route
                    path="/lendas/cliches-blues"
                    element={<ClichesBlues />}
                  />
                  <Route
                    path="/braco-violao"
                    element={<FretboardPlayground />}
                  />
